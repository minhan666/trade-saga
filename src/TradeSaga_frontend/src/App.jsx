...
import { createActor } from "declarations/TradeSaga_backend"; // Updated import
import { canisterId } from "declarations/TradeSaga_backend/index.js"; // Updated import
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex flex-row justify-between">
        <h1 className="mb-4 text-2xl font-bold">TradeSaga</h1>
